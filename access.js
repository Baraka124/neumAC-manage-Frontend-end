...
return {
  ...
  setup(props,{emit}) {
    ...
    const state=reactive({loaded:false,loading:false,busy:false,error:'',notice:'',users:[],query:'',status:'',role:'',selected:null,snapshot:null,events:[],catalog:[],invites:false,devEnabled:false,testEnabled:false,roster:[],tab:'team',teamQuery:'',teamStatus:'',teamDepartment:'',focusDomain:'staff',staffQuery:'',staffId:'',mode:'invitation',temporaryPassword:'',detailLoading:false});
