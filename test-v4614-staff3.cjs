...
test('P3-16 architecture advances to Staff Phase 3',()=>{assert(arch.includes('Architecture v2.5')||arch.includes('Architecture v2.6')||arch.includes('Architecture v2.7')||arch.includes('Architecture v2.8'));assert(arch.includes('Staff Phase 3 — Adaptive resident profile'))});
