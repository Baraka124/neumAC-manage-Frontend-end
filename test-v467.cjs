...
const tests = [
  ['V46.7 build/cache markers', () => {
    ...
    assert(html.includes('style.css?v=46.7-clinical-units-adaptive') || html.includes('style.css?v=46.8-grounded-architecture') || html.includes('style.css?v=46.9-grounded-action-integrity') || html.includes('style.css?v=46.10-leave-action-integrity') || html.includes('style.css?v=46.11-rotation-action-integrity') || (html.includes('style.css?v=46.12-clinical-units') || html.includes('style.css?v=46.14-grounded-presentation-convergence')))
  }],
