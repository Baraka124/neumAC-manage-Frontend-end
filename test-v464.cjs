...
const tests = [
  ...
  ['team load failure is distinct from an empty team', () => { assert(app.includes('unitStaffErrors')); assert(html.includes('Attending links unavailable')); assert(html.includes('Retry')) }],
