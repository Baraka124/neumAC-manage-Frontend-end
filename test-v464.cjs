...
const tests = [
  ['V46.4 build marker and cache key', () => { assert(html.includes('neumDesk · V46.4') || html.includes('neumDesk · V46.5')); assert(html.includes('app.js?v=46.4-clinical-units') || html.includes('app.js?v=46.5-clinical-units')) }],
