...
const tests=[
 ['V46.12 markers',()=>{assert(html.includes('neumDesk · V46.12')||html.includes('neumDesk · V46.13')||html.includes('neumDesk · V46.14'));assert(html.includes('app.js?v=46.12-clinical-units')||html.includes('app.js?v=46.13-portfolio-intelligence')||html.includes('app.js?v=46.14-personal-activity-workspace'));assert(html.includes('style.css?v=46.12-clinical-units'))}],
