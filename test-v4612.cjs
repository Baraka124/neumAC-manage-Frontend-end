...
const tests=[
 ['V46.12 markers',()=>{assert(html.includes('neumDesk · V46.12'));assert(html.includes('app.js?v=46.12-clinical-units'));assert(html.includes('style.css?v=46.12-clinical-units'))}],
 ...
 ['living architecture advanced',()=>{assert(dept.includes('Implementation checkpoint: V46.12'));assert(dept.includes('Personal Activity / Portfolio Intelligence'))}],
